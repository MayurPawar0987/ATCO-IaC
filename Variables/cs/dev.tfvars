...
subnets = {
  "snet-app"               = { address_prefixes = ["10.42.1.0/24"], delegation = null }
  "snet-data"              = { address_prefixes = ["10.42.2.0/24"], delegation = null }
  "snet-integration" = {
  ...
  "AzureFirewallSubnet"    = { address_prefixes = ["10.42.4.0/26"], delegation = null }
  "snet-private-endpoints" = { address_prefixes = ["10.42.5.0/24"], delegation = null }
